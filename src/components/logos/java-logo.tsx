interface JavaLogoProps extends React.SVGProps<SVGSVGElement> { }

const JavaLogo = ({ className }: JavaLogoProps) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 346">

interface LaravelLogoProps extends React.SVGProps<SVGSVGElement> { }

const LaravelLogo = ({ className }: LaravelLogoProps) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 264">
